...
__help__ = """
 ...
 sinnerXmusic plays plays music in your group's voice chat
 
 Assistant name >> see on my bio
...
*) If userbot joined enjoy music, If not add assistant to your group and retry
