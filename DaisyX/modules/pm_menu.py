...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/zerosquad13/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/xproject13"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/xproject13"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "💥𝐀𝐃𝐃 𝐓𝐎 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏💥",
            url=f"https://telegram.me/supersinnerbot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/supersinnerbot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
